package com.scienstechnologies.tollyteaser.navigationdrawer;
...
public class FragmentDrawer extends Fragment {
    ...
    private static String[] titlesAuth = null;
    private FragmentDrawerListener drawerListener;
    public static String uid, regUid, onSuccess = "";
